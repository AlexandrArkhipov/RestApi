...
$.getJSON("http://localhost:8080/api/objects/product/read_one.php?id=" + id, function(data){
	...
	$.getJSON("http://localhost:8080/api/objects/category/read.php", function(data){
...
$(document).on('submit', '#update-product-form', function(){
    ...
    $.ajax({
        url: "http://localhost:8080/api/objects/product/update.php",
        type : "POST",
